...
%                argBorder = true; 
    ...
    dlgWindows = ...
        dialog('Position', [dPositionX dPositionY dlgWindowsSizeX dlgWindowsSizeY],...
               'Name'    , s.xmlParametersGui.guiName.Text,...
               'Color'   , guiBackgroundColor('get'),...
               'resize'  , 'off'...
              );
...
%    javaFrame.setFigureIcon(javax.swing.ImageIcon('.\logo.png'));
    ...
    txtDefaultProtocol = ...
        uicontrol(dlgWindows,...
                  ...
                  'BackgroundColor'    , guiBackgroundColor('get'), ...
                  'ForegroundColor'    , guiForegroundColor('get'), ...                  
    ...
    function aColor = guiBackgroundColor(sAction, aValue)
    ...
    function aColor = guiForegroundColor(sAction, aValue)
